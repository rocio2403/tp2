...
public class CiudadTest {
    ...
    @BeforeEach
    public void setUp() {
        ciudad = new Ciudad(1, 100.0, 200.0, 100.0); // id=1, pérdidas=100.0, ganancias=200.0, superávit=100.0
    }
    ...
    public void testMultipleActualizaciones() {
        ...
        // Agregar ganancias
        ciudad.agregarGanancias(50.0);  // 200.0 + 50.0 = 250.0
        ciudad.agregarGanancias(100.0); // 250.0 + 100.0 = 350.0
    
        // Agregar pérdidas
        ciudad.agregarPerdidas(30.0);   // 100.0 + 30.0 = 130.0
        ciudad.agregarPerdidas(70.0);   // 130.0 + 70.0 = 200.0
